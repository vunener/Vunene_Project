...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 12, 2025 at 02:36 PM
...
(279, 1109, 73, 'completed', '2026-05-25', '2025-11-10 12:09:10', 1, 'Your booking is pending approval.');
...
(166, 279, 100.00, '2025-11-10 12:07:41', 'completed', 'uploads/proof_6911b96ddf916.pdf');
...
--
ALTER TABLE `bookings`
  MODIFY `bookingID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=281;
...
--
ALTER TABLE `notifications`
  MODIFY `notificationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=335;

--
-- AUTO_INCREMENT for table `parents`
--
ALTER TABLE `parents`
  MODIFY `parentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;

--
-- AUTO_INCREMENT for table `payments`
--
ALTER TABLE `payments`
  MODIFY `paymentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=168;
...
--
ALTER TABLE `waitinglist`
  MODIFY `waitingID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;
